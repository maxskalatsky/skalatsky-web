...
jQuery(function ($) {
   ...
   /* ======= Contact form ======= */
   $('.js-contact').on('submit', function(event) {
      event.preventDefault();
      $('.js-contact-alert').hide();
      ...
      $.post("/api/contact.php", data)
         .done(function(res, statusText, xhr) {
            if (xhr.status === 200) {
               ...
               $('html,body').animate({scrollTop: $('.js-contact').offset().top - 15 - $('.navbar-header').height()}, 'slow');
            } else {
   ...
   $('#fixed-collapse-navbar')
      .on('show.bs.collapse', function() { $('#navigation').addClass('nav-black'); })
      .on('hide.bs.collapse', function() { $('#navigation').removeClass('nav-black'); });
   ...
   $(".scrollings").on("click", function (event) {
      if (this.hash !== "") {
         event.preventDefault();
         var hash = this.hash;
         $('#fixed-collapse-navbar').collapse('hide');
         $("html, body").animate({
   ...
   $('#type_it_slider').typeIt({
      ...
      .tiType('Focusing on the right people')
      .tiSettings({
         speed: 700
      })
      .tiPause(1000)
      ...
      .tiDelete()
      .tiType('Identifying culture as an asset')
      .tiSettings({
         speed: 700
      })
      .tiPause(1000)
      ...
      .tiDelete()
      .tiType('Highlighting successful behavior traits');
